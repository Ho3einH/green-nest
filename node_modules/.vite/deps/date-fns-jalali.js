...
function format(date, formatStr, options) {
  const defaultOptions2 = getDefaultOptions();
  const locale = options?.locale ?? defaultOptions2.locale ?? faIR;
  const firstWeekContainsDate = options?.firstWeekContainsDate ?? options?.locale?.options?.firstWeekContainsDate ?? defaultOptions2.firstWeekContainsDate ?? defaultOptions2.locale?.options?.firstWeekContainsDate ?? 1;
  const weekStartsOn = options?.weekStartsOn ?? options?.locale?.options?.weekStartsOn ?? defaultOptions2.weekStartsOn ?? defaultOptions2.locale?.options?.weekStartsOn ?? 6;
...
function getDate2(date, options) {
...
function isLeapYear2(date, options) {
  const _date = toDate(date, options?.in);
  const year = getFullYear(_date);
...
function getMonth2(date, options) {
...
function getWeekOfMonth(date, options) {
  const defaultOptions2 = getDefaultOptions();
  const weekStartsOn = options?.weekStartsOn ?? options?.locale?.options?.weekStartsOn ?? defaultOptions2.weekStartsOn ?? defaultOptions2.locale?.options?.weekStartsOn ?? 6;
  const currentDayOfMonth = getDate2(toDate(date, options?.in));
...
function setMonth2(date, month, options) {
  const _date = toDate(date, options?.in);
  const year = getFullYear(_date);
...
function setDate2(date, dayOfMonth, options) {
  const _date = toDate(date, options?.in);
