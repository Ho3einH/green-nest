...
import { C as useQueryClient, z as onlineManager } from "./modern-BZiiIKsO.js";
import { t as require_jsx_runtime } from "./jsx-runtime-DVndpZax.js";
import { I as lazy, K as setupStyleSheet, R as mergeProps, S as createSignal, U as render, h as createComponent } from "./CXOMC62J-BuDS-SVs.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./7HGFFDPC-CSVffXf8.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./ONXD5SSW-euim6z-F.js"));
				this.#Component = Devtools;
			}
			setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
			return createComponent(Devtools, mergeProps({
