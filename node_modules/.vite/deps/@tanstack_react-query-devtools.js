...
import { C as useQueryClient, z as onlineManager } from "./modern-VkV_OyIn.js";
import { t as require_jsx_runtime } from "./jsx-runtime-BuYTW0JP.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./7HGFFDPC-DoOgMdUZ.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./ONXD5SSW-CdN4yitF.js"));
				this.#Component = Devtools;
			}
			setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
			return createComponent(Devtools, mergeProps({
