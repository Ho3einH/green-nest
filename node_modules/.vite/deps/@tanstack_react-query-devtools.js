...
import { t as require_react } from "./react-BBGzHI1o.js";
import { C as useQueryClient, z as onlineManager } from "./modern-DTtb7v8t.js";
import { t as require_jsx_runtime } from "./jsx-runtime-DvD3g_Jv.js";
import { I as lazy, K as setupStyleSheet, R as mergeProps, S as createSignal, U as render, h as createComponent } from "./CXOMC62J-BC6KLcgu.js";
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./7HGFFDPC-DtopowGR.js"));
	...
	mount(el) {
		...
		const dispose = render(() => {
			...
			if (this.#Component) Devtools = this.#Component;
				...
				Devtools = lazy(() => import("./ONXD5SSW-Os414bZI.js"));
				this.#Component = Devtools;
			}
			setupStyleSheet(this.#styleNonce, this.#shadowDOMTarget);
			return createComponent(Devtools, mergeProps({
