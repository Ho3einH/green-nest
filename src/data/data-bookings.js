...
export const bookings = [
  // CABIN 001
  {
    ...
    guestId: 2,
    hasBreakfast: true,
    observations: "به گلوتن حساسیت دارم، لطفاً صبحانه بدون گلوتن آماده شود.",
    isPaid: false,
    numGuests: 1,
  },
  {
  ...
  },
  {
    ...
    guestId: 9,
    hasBreakfast: false,
    observations: "سگ کوچک خود را همراه خواهیم داشت.",
    isPaid: true,
    numGuests: 3,
  },
  {
  ...
  // CABIN 006
  {
    ...
    guestId: 17,
    hasBreakfast: false,
    observations: "ورود ما حدود نیمه‌شب خواهد بود، ممنون می‌شویم هماهنگ شود.",
    isPaid: true,
    numGuests: 6,
  },
  {
    ...
    guestId: 18,
    hasBreakfast: true,
    observations: "به یک تخت اضافه برای یکی از مهمانان نیاز داریم.",
    isPaid: true,
    numGuests: 4,
  },
  {
  ...
  // CABIN 008
  {
    ...
    guestId: 1,
    hasBreakfast: true,
    observations: "همسرم به گلوتن حساس است، لطفاً صبحانه بدون گلوتن آماده شود.",
    isPaid: true,
    numGuests: 9,
  },
  {
    ...
    hasBreakfast: true,
    observations:
      "در حال جشن سالگرد هستیم، لطفاً در صورت امکان امکانات ویژه یا تزئینات فراهم شود.",
    isPaid: true,
    numGuests: 10,
  },
  {
